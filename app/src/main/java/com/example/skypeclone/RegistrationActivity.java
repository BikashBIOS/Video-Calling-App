    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                if (continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent.")) {
                    ...
                    if (!phoneNumber.equals("")){
                        ...
                        loadingBar.setMessage("Please wait, while verification is done");
                        loadingBar.setCanceledOnTouchOutside(false);
                        loadingBar.show();
                        ...
                        Toast.makeText(RegistrationActivity.this, "Please Validate Phone Number", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        mCallbacks= new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Toast.makeText(RegistrationActivity.this, "Code Sent. Please check your Inbox", Toast.LENGTH_SHORT).show();
            }
        };
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congratulations, you are successfully logged in.", Toast.LENGTH_SHORT).show();
